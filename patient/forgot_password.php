...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email)) {
        ...
        $result = $passwordReset->sendResetLink($email, 'patient');
...
<body class="min-h-screen flex items-center justify-center p-6">
    <div class="glass-card p-8 w-full max-w-md">
        ...
        <div class="bg-green-100 border-l-4 border-green-500 p-4 mb-6 rounded">
            ...
            <p class="text-green-600 text-sm mt-2">Check your email inbox (and spam folder) for the reset link.</p>
            <a href="login.php" class="text-green-700 font-semibold hover:underline mt-3 inline-block">
                ← Back to Login
            </a>
        </div>
        <?php else: ?>
        ...
        <div class="mt-6 text-center text-sm text-gray-600">
            <p>Don't have an account? <a href="register.php" class="text-indigo-600 font-semibold hover:underline">Register here</a></p>
        </div>
